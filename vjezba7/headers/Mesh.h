...
public:
    ...
    Mesh(std::vector<glm::vec4> v, std::vector<unsigned int> f, GLuint s, GLint u_c, glm::vec3 c, GLint u_model_matrix, GLint u_view_matrix, GLint u_projection_matrix, GLint u_eye);
    ~Mesh();
